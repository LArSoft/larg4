...
namespace evgen {
  ...
  class larg4SingleGen : public art::EDProducer {
  ...
  public:
    ...
    explicit larg4SingleGen(Parameters const& config);
  ...
  private:
    ...
    static constexpr int kSelectOneRandPart =
      1; ///< One particle is generated, extracted from the provided options.
    /// @}
    ...
    std::vector<std::unique_ptr<TH2>>
      hThetaXzYzHist; /// actual TH2 for angle distributions - Xz on x axis .
...
namespace evgen {
  ...
  std::map<int, std::string> larg4SingleGen::makeParticleSelectionModeNames()
  {
    std::map<int, std::string> names;
    names[int(kSelectAllParts)] = "all";
    names[int(kSelectOneRandPart)] = "singleRandom";
    return names;
  } // larg4SingleGen::makeParticleSelectionModeNames()

  std::map<int, std::string> larg4SingleGen::makeDistributionNames()
  {
    std::map<int, std::string> names;
    ...
    return names;
  } // larg4SingleGen::makeDistributionNames()

  const std::map<int, std::string> larg4SingleGen::ParticleSelectionModeNames =
    larg4SingleGen::makeParticleSelectionModeNames();
  const std::map<int, std::string> larg4SingleGen::DistributionNames =
    larg4SingleGen::makeDistributionNames();

  template <typename OptionList>
  auto larg4SingleGen::selectOption(std::string Option, OptionList const& allowedOptions)
    -> decltype(auto)
  {
  ...
  } // larg4SingleGen::selectOption()

  template <typename OptionList>
  std::string larg4SingleGen::presentOptions(
    OptionList const& allowedOptions,
    bool printKey /* = true */,
    std::initializer_list<typename OptionList::value_type::first_type> exclude /* = {} */
  )
  {
    ...
    return msg;
  } // larg4SingleGen::presentOptions()

  template <typename OptionList>
  std::string larg4SingleGen::optionName(typename OptionList::value_type::first_type optionKey,
                                         OptionList const& allowedOptions,
                                         std::string defName /* = "<unknown>" */
  )
  {
  ...
  } // larg4SingleGen::optionName()

  //____________________________________________________________________________
  bool larg4SingleGen::Config::fromHistogram(std::string const& key) const
  {
    return selectOption(PDist(), DistributionNames) == kHIST;
  } // larg4SingleGen::Config::fromHistogram()

  //____________________________________________________________________________
  larg4SingleGen::larg4SingleGen(Parameters const& config)
    : EDProducer{config}
  ...
  //____________________________________________________________________________
  void larg4SingleGen::beginRun(art::Run& run) {}

  //____________________________________________________________________________
  void larg4SingleGen::setup()
  {
    ...
    if (list.size() > 0)
      throw cet::exception("larg4SingleGen")
  ...
  //____________________________________________________________________________
  bool larg4SingleGen::PadVector(std::vector<double>& vec)
  {
  ...
  //____________________________________________________________________________
  void larg4SingleGen::produce(art::Event& evt)
  {
    ...
    MF_LOG_DEBUG("larg4SingleGen") << truth;
  ...
  // FCIHL description
  void larg4SingleGen::SampleOne(unsigned int i, simb::MCTruth& mct)
  {
  ...
  void larg4SingleGen::SampleMany(simb::MCTruth& mct)
  {
  ...
  //____________________________________________________________________________
  void larg4SingleGen::Sample(simb::MCTruth& mct)
  {
    ...
    default:
      mf::LogWarning("UnrecognizeOption")
        << "larg4SingleGen does not recognize ParticleSelectionMode " << fMode;
      break;
    } // switch on fMode
  ...
  //____________________________________________________________________________
  void larg4SingleGen::printVecs(std::vector<std::string> const& list)
  {

    mf::LogInfo("larg4SingleGen")
    ...
    mf::LogInfo("larg4SingleGen") << values;

    return;
  }

  //____________________________________________________________________________
  double larg4SingleGen::SelectFromHist(const TH1& h) // select from a 1D histogram
  {
    CLHEP::RandFlat flat(fEngine);
  ...
  //____________________________________________________________________________
  void larg4SingleGen::SelectFromHist(const TH2& h,
                                      double& x,
                                      double& y) // select from a 2D histogram
  {
    CLHEP::RandFlat flat(fEngine);
...
namespace evgen {
  ...
  DEFINE_ART_MODULE(larg4SingleGen)
